<div class="sidebar__nav">
    ...
    <ul>
        <li class="item-li i-dashboard"><a href="/admin">پیشخوان</a></li>

        <li class="item-li i-courses has-sub-ui"><a class="has-arrow-ui" href="#">دوره ها</a>
            <ul class="collapse show" style="height: 0px;">
                <li><a href="create-new-course.html">ایجاد محصول</a></li>
                <li><a href="courses.html">لیست محصول</a></li>
            </ul>
        </li>

        <li class="item-li i-users has-sub-ui open"><a class="has-arrow-ui" href="#"> کاربران</a>
            <ul class="collapse show" style="height: 49px;">
